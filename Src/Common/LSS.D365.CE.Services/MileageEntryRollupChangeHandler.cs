...
{
    public class MileageEntryRollupChangeHandler : IRollupEntityChangeHandler
    {
        private readonly IOrganizationService _orgSvc;
        private readonly ITracingService _tracingSvc;

        public MileageEntryRollupChangeHandler(IOrganizationService orgSvc, ITracingService tracingSvc)
        {
        ...
        {
            var mileageEntry = preImage.ToEntity<new_mileageentry>();

            if (mileageEntry.new_budgetlineid == null)
            {
            ...
            var saDetail = _orgSvc.Retrieve(
                    ...
                    mileageEntry.new_budgetlineid.Id,
                    new ColumnSet(
